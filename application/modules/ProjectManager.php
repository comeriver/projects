		...
		//	var_export( $data );
			...
			(
				array(
						...
						' ' => array( 'field' => 'article_url', 'value' =>  '<a href="javascript:" onClick="ayoola.spotLight.showLinkInIFrame( \'' . Ayoola_Application::getUrlPrefix() . '/tools/classplayer/get/object_name/Application_Article_Editor?article_url=%FIELD%\', \'' . $this->getObjectName() . '\' );" title=""><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>', 'filter' =>  '' ), 
						'' => array( 'field' => 'article_url', 'value' =>  '<a href="javascript:" onClick="ayoola.spotLight.showLinkInIFrame( \'' . Ayoola_Application::getUrlPrefix() . '/tools/classplayer/get/object_name/Application_Article_Delete?article_url=%FIELD%\', \'' . $this->getObjectName() . '\' );" title=""><i class="fa fa-trash" aria-hidden="true"></i></a>', 'filter' =>  '' ), 
					)
			);
